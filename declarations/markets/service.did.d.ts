...
export interface AssetEncoding {
  'modified' : bigint,
  'certified' : boolean,
  'content_chunks' : Array<Uint8Array | number[]>,
  'total_length' : bigint,
}
...
export type Result_10 = { 'ok' : StablePost } |
  { 'err' : Error };
export type Result_11 = { 'ok' : Array<[string, Uint32Array | number[]]> } |
  { 'err' : Error };
...
export interface StableState1 {
  'hashtags' : Array<[string, Uint32Array | number[]]>,
  'payments' : Array<Payment>,
  'bets' : Array<[number, SimpleMarketStable]>,
  'feed' : Uint32Array | number[],
  'handles' : Array<[string, string]>,
...
export interface UserMarket {
  ...
  'spent' : bigint,
  'marketId' : number,
  'balances' : BigUint64Array | bigint[],
}
