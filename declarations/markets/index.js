...
import { idlFactory } from './markets.did.js';
export { idlFactory } from './markets.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MARKETS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./markets.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the markets canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./markets.did.js")._SERVICE>}
 */
export const markets = createActor(canisterId);
